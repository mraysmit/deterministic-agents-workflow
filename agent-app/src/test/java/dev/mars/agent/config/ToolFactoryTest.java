...
class ToolFactoryTest {
  ...
  void creates_publish_event_tool(Vertx vertx) {
    AgentTool tool = ToolFactory.create("publish-event", vertx, "events.out");
  ...
  void creates_raise_ticket_tool(Vertx vertx) {
    AgentTool tool = ToolFactory.create("raise-ticket", vertx, "events.out");
  ...
  void creates_lookup_tool(Vertx vertx) {
    AgentTool tool = ToolFactory.create("lookup", vertx, "events.out");
  ...
  void creates_classify_tool(Vertx vertx) {
    AgentTool tool = ToolFactory.create("classify", vertx, "events.out");
  ...
  void creates_notify_tool(Vertx vertx) {
    AgentTool tool = ToolFactory.create("notify", vertx, "events.out");
